 ...
 * completed here applies to the main window too.</p>
 */
public final class AuthPopupDialog {
    ...
    public static void show(WebView popupView, String url, Window owner) {
        ...
        dialog.setOnCloseRequest(e -> AppLog.info("Sign-in window closed."));
